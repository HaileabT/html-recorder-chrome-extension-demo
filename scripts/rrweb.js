var rrweb = (function (exports) {
  ...
  function getBaseDimension(node, rootIframe) {
    var _a, _b;
    const frameElement =
      (_b = (_a = node.ownerDocument) == null ? void 0 : _a.defaultView) == null ? void 0 : _b.frameElement;
    ...
    constructor() {
      ...
      this.emit = () => {
        ...
        const pushAdd = (n) => {
          ...
          let shadowHost = null;
          if (
            ((_b = (_a = n.getRootNode) == null ? void 0 : _a.call(n)) == null ? void 0 : _b.nodeType) ===
  ...
  function initMouseInteractionObserver({ mouseInteractionCb, doc, mirror, blockClass, blockSelector, sampling }) {
    ...
    const disableMap =
      sampling.mouseInteraction === true || sampling.mouseInteraction === void 0 ? {} : sampling.mouseInteraction;
    const handlers = [];
  ...
  class ShadowDomManager {
    ...
    observeAttachShadow(iframeElement) {
      if (iframeElement.contentWindow) {
        const manager = this;
        this.restorePatches.push(
          patch(iframeElement.contentWindow.HTMLElement.prototype, "attachShadow", function (original) {
            return function (option) {
              const shadowRoot = original.call(this, option);
              ...
              left:
                window.pageXOffset !== void 0
                  ...
                  : (document == null ? void 0 : document.documentElement.scrollLeft) ||
                    ((_b = (_a = document == null ? void 0 : document.body) == null ? void 0 : _a.parentElement) == null
                      ? void 0
                      : _b.scrollLeft) ||
                    ((_c = document == null ? void 0 : document.body) == null ? void 0 : _c.scrollLeft) ||
                    0,
              top:
                window.pageYOffset !== void 0
                  ? window.pageYOffset
                  : (document == null ? void 0 : document.documentElement.scrollTop) ||
                    ((_e = (_d = document == null ? void 0 : document.body) == null ? void 0 : _d.parentElement) == null
                      ? void 0
                      : _e.scrollTop) ||
                    ((_f = document == null ? void 0 : document.body) == null ? void 0 : _f.scrollTop) ||
                    0,
            },
          },
        })
  ...
  function BaseRRDocumentImpl(RRNodeClass) {
    return class BaseRRDocument extends RRNodeClass {
      ...
      get documentElement() {
        return (
          this.childNodes.find((node) => node.RRNodeType === NodeType$1.Element && node.tagName === "HTML") || null
        );
      }
      get body() {
        var _a;
        return (
          ((_a = this.documentElement) === null || _a === void 0
            ? void 0
            : _a.childNodes.find((node) => node.RRNodeType === NodeType$1.Element && node.tagName === "BODY")) || null
        );
      }
      get head() {
        var _a;
        return (
          ((_a = this.documentElement) === null || _a === void 0
            ? void 0
            : _a.childNodes.find((node) => node.RRNodeType === NodeType$1.Element && node.tagName === "HEAD")) || null
        );
      }
      get implementation() {
        return this;
          ...
          case "CANVAS":
            {
              ...
              rrCanvasElement.canvasMutations.forEach((canvasMutation) =>
                replayer.applyCanvas(canvasMutation.event, canvasMutation.mutation, oldTree)
              );
            }
            break;
          case "STYLE":
  ...
  function diffProps(oldTree, newTree, rrnodeMirror) {
    ...
    for (const name in newAttributes) {
      ...
      if (sn && "isSVG" in sn && sn.isSVG && NAMESPACES[name]) oldTree.setAttributeNS(NAMESPACES[name], name, newValue);
    ...
    for (const { name } of Array.from(oldAttributes)) if (!(name in newAttributes)) oldTree.removeAttribute(name);
  ...
  function buildFromDom(dom, domMirror = createMirror$1(), rrdom = new RRDocument()) {
    function walk2(node, parentRRNode) {
      ...
      if (
        (parentRRNode === null || parentRRNode === void 0 ? void 0 : parentRRNode.nodeName) !== "IFRAME" &&
      ...
      if (node.nodeName === "IFRAME") {
        ...
        if (node.nodeType === NodeType.ELEMENT_NODE && node.shadowRoot) walk2(node.shadowRoot, rrNode);
  ...
  function s(n, o) {
    ...
    var s = t(
      ...
      y = {
        config: n,
        _options: o,
        initialState: { value: n.initial, actions: l, context: v, matches: a(n.initial) },
      ...
      c = {
        ...
        start: function (i) {
          if (i) {
            ...
            r = { value: u.value, actions: [], context: u.context, matches: a(u.value) };
          }
      ...
      },
      {
        actions: {
          ...
          play(ctx) {
            ...
            if (
              (lastPlayedEvent == null ? void 0 : lastPlayedEvent.type) === EventType.IncrementalSnapshot &&
              lastPlayedEvent.data.source === IncrementalSource.MouseMove
            ) {
              lastPlayedTimestamp =
                lastPlayedEvent.timestamp + ((_a = lastPlayedEvent.data.positions[0]) == null ? void 0 : _a.timeOffset);
            }
  ...
  function webglMutation(_0) {
    return __async$3(this, arguments, function* ({ mutation, target, type, imageMap, errorHandler }) {
      try {
  ...
  function canvasMutation$1(_0) {
    return __async$2(this, arguments, function* ({ event, mutation, target, imageMap, errorHandler }) {
      try {
  ...
  function canvasMutation(_0) {
    return __async$1(this, arguments, function* ({ event, mutation, target, imageMap, canvasEventMap, errorHandler }) {
      try {
  ...
  function indicatesTouchDevice(e) {
    return (
      ...
      (e.data.source == IncrementalSource.TouchMove ||
        (e.data.source == IncrementalSource.MouseInteraction && e.data.type == MouseInteractions.TouchStart))
    );
  }
  class Replayer {
                ...
                for (const _event of this.service.state.context.events) {
                  ...
                  if (this.isUserInteraction(_event)) {
                    if (
                      ...
                      SKIP_TIME_THRESHOLD * this.speedService.state.context.timer.speed
                    ) {
    ...
    play(timeOffset = 0) {
      ...
      (_b = (_a = this.iframe.contentDocument) == null ? void 0 : _a.getElementsByTagName("html")[0]) == null
        ? void 0
    ...
    applyMutation(d, isSync) {
      ...
      uniqueTextMutations(d.texts).forEach((mutation) => {
        ...
        if (this.usingVirtualDom) {
          ...
          if (((_a = parent == null ? void 0 : parent.rules) == null ? void 0 : _a.length) > 0) parent.rules = [];
        }
      });
    ...
    applyStyleSheetMutation(data) {
      ...
      else if (data.id) styleSheet = ((_a = this.mirror.getNode(data.id)) == null ? void 0 : _a.sheet) || null;
