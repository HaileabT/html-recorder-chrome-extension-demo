var rrwebSnapshot = (function (exports) {
  ...
  function serializeNodeWithId(n, options) {
    ...
    if (
      (serializedNode.type === exports.NodeType.Document || serializedNode.type === exports.NodeType.Element) &&
      recordChild
    ) {
      if (
    ...
    if (serializedNode.type === exports.NodeType.Element && serializedNode.tagName === "iframe") {
      onceIframeLoaded(
        n,
        function () {
  ...
  function visitSnapshot(node, onVisit) {
    function walk(current) {
      onVisit(current);
      if (current.type === exports.NodeType.Document || current.type === exports.NodeType.Element) {
  ...
  function buildNodeWithSN(n, options) {
    ...
    if (n.type === exports.NodeType.Document) {
      doc.close();
      doc.open();
      if (n.compatMode === "BackCompat" && n.childNodes && n.childNodes[0].type !== exports.NodeType.DocumentType) {
        if (
          n.childNodes[0].type === exports.NodeType.Element &&
    ...
    mirror.add(node, n);
    if ((n.type === exports.NodeType.Document || n.type === exports.NodeType.Element) && !skipChild) {
